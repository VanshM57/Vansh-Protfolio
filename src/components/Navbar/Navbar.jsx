  ...
  ${isScrolled ? "bg-[#050414] bg-opacity-50 backdrop-blur-md shadow-md}":"bg-transparent"}'>
      <div className="text-white py-5 flex justify-between items-center">
        ...
        <div className='hidden md:flex space-x-4'>
          <a href="https://github.com/VanshM57" target="_blank" rel='noopener noreferrer'
           className='text-gray-300 hover:text-[#8245ec]'>
            <FaGithub size={24} />
          </a>
          <a href="https://www.linkedin.com/in/vansh-mishra-70803b2a8" target="_blank" rel='noopener noreferrer'
           className='text-gray-300 hover:text-[#8245ec]'>
            <FaLinkedin size={24} />
          </a>
        </div>
      ...
      {/* mobile menu items */}
      {isOpen && (
        <div className='md:hidden absolute top-16 left-1/2 transform -translate-x-1/3 w-4/5 bg-[#050414]
         bg-opacity-50 backdrop-filter backdrop-blur-lg rounded-lg shadow-lg'>
          <ul className='flex flex-col items-center space-y-4 text-gray-300'>
            ...
            <div className='flex space-x-4'>
              ...
              <a href="https://www.linkedin.com/in/vanshmishra/" target="_blank" rel='noopener noreferrer'
               className='text-gray-300 hover:text-[#8245ec]'>
                <FaLinkedin size={24} />
              </a>
            </div>
